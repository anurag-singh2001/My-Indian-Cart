...
export default function Home() {
  return (
    <div>
      ...
      <Head>
        <title>My Indian Cart</title>
        <meta name="description" content="My Indian Cart " />
        <link rel="icon" href="/favicon.ico" />
      </Head>


      <div>
        <img src="/home.jpg" alt="banner" width={1300} height={450} />
      </div>
      <section className="text-black-400 bg-white-900 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-black">My Indian Cart </h1>
            <p className="lg:w-1/2 w-full leading-relaxed text-opacity-80">Made in India</p>
          </div>
